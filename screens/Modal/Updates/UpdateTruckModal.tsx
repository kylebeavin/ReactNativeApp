...
const UpdateTruckModal: React.FC<Props> = ({model}) => {
  //#region Form Initializers
  const formValues = {
    body_subtype: model.body_subtype,
    body_type: model.body_type,
    color: model.color,
    documents: model.documents,
    group_id: model.group_id,
    hours: model.hours.toString(),
    is_active: model.is_active.toString(),
    license_number: model.license_number,
    msrp: model.msrp.toString(),
    name: model.name,
    odo: model.odo.toString(),
    operator: model.operator,
    ownership: model.ownership,
    pictures: model.pictures,
    service_history: model.service_history,
